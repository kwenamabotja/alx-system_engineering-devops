...
In most projects, we often give you only one main file to test with. For example, this main file is a test for a `positive_or_negative()` function similar to the one you worked with in [an earlier C task](https://github.com/monoprosito/mainschool-low_level_programming/blob/master/0x01-variables_if_else_while/0-positive_or_negative.c):
...
You are not coding the solution / function, you’re just testing it! However, you can adapt your function from [Positive or Negative task](https://github.com/monoprosito/mainschool-low_level_programming/blob/master/0x01-variables_if_else_while/0-positive_or_negative.c) to compile with this main file to test locally.

* You only need to upload `0-main.c` and `main.h` for this task. We will provide our own `positive_or_negative()` function.
* You are not allowed to add or remove lines of code, you may change only **one** line in this task.

**Solution:** [0-main.c](https://github.com/monoprosito/mainschool-low_level_programming/blob/master/0x03-debugging/0-main.c), [main.h](https://github.com/monoprosito/mainschool-low_level_programming/blob/master/0x03-debugging/main.h)
...
**Solution:** [1-main.c](https://github.com/monoprosito/mainschool-low_level_programming/blob/master/0x03-debugging/1-main.c)
...
**Solution:** [2-largest_number.c](https://github.com/monoprosito/mainschool-low_level_programming/blob/master/0x00-hello_world/0-preprocessor), [main.h](https://github.com/monoprosito/mainschool-low_level_programming/blob/master/0x03-debugging/main.h)
